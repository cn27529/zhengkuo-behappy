// src/models/join_record.rs
use serde::{Deserialize, Serialize};
use sqlx::FromRow;
use serde_json::Value as JsonValue;

/// 參與記錄模型 - 對應 joinRecordDB 表結構
#[allow(dead_code)]
...
pub struct CreateJoinRecordRequest {
    #[serde(default)]
    pub registration_id: Option<i64>,
...
#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct UpdateJoinRecordRequest {
    pub registration_id: Option<i64>,
    pub activity_id: Option<i64>,
    pub state: Option<String>,
    pub items: Option<JsonValue>,
...
impl From<JoinRecord> for JoinRecordResponse {
    fn from(data: JoinRecord) -> Self {
        Self {
            id: data.id,
