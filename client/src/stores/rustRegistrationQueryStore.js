// src/stores/rustRegistrationQueryStore.js
...
export const useQueryStore = defineStore("query", () => {
  ...
  const queryRegistrationData = async (queryData) => {
    ...
    try {
      // 檢查是否為 Mock 模式
      if (serviceAdapter.registrationService.getIsMock()) {
      ...
      const result =
        await serviceAdapter.registrationService.getAllRegistrations(params);
