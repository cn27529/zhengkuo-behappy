...
| 服務名稱             | Port | 存取網址            | 說明                   |
| -------------------- | ---- | ------------------- | ---------------------- |
| 前端 (Vue 3 + Vite)  | 5173 | http://0.0.0.0:5173 | 主要使用者介面         |
| Rust Axum 後端       | 3000 | http://0.0.0.0:3000 | 主要 API 服務          |
| Directus 後端 (備用) | 8055 | http://0.0.0.0:8055 | Node.js / CMS 管理介面 |
| 文檔服務器           | 3001 | http://0.0.0.0:3001 | Markdown 文件瀏覽      |
| 日誌服務器           | 3002 | http://0.0.0.0:3002 | API 日誌收集與查詢     |
...
# 日誌服務器
VITE_LOG_SERVER_URL=http://0.0.0.0:3002
...
# MONGODB_URI=mongodb://0.0.0.0:27017/zk_logs
```
...
cd client
npm run dev
# 預期：VITE ready — http://0.0.0.0:5173/
```
...
- [ ] http://0.0.0.0:5173 — 前端頁面正常載入，顯示登入畫面
- [ ] http://0.0.0.0:3000 — Rust API 有回應
- [ ] http://0.0.0.0:3001 — 文檔服務器顯示文件列表
- [ ] http://0.0.0.0:3002/health — 回應 `{"status":"ok"}`
...
- [ ] http://0.0.0.0:5173 前端頁面正常
- [ ] http://0.0.0.0:3000 Rust API 有回應
- [ ] http://0.0.0.0:3001 文檔服務器正常
- [ ] http://0.0.0.0:3002/health 回應 ok
- [ ] 使用者可登入，進入主畫面
- [ ] 消災超度登記功能正常
- [ ] 每月贊助功能正常
- [ ] 活動管理功能正常
